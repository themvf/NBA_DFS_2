...
def run(conn):
    ...
    return {'version': VERSION, 'runtime': {'scipy': scipy.__version__, 'numpy': np.__version__},
        ...
        'limitations': [
            ...
            'Missing result rows remain unknown, including possible DNPs. Hindsight optimality is certified only over reconciled players.',
            'This is an isolated historical-baseline diagnostic, not a replay of the fully connected production optimizer. It includes the archived salary pool without retrospective status filtering. No timestamped pre-lock injury/depth-chart/scheme overlay is available in this pilot.',
