...
- The Best Ball roster planner persists locally per ranking-set snapshot and does not mutate draft sessions or the materialized player rankings. It validates the official roster gates as players are added or removed.
