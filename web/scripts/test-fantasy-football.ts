...
assert.deepEqual(getYahooDraftTiming({ ourRank: 63, yahooXRank: 124.1, yahooAdp: 95.3, nextUserPick: 63, followingUserPick: 72, teamCount: 12 }), { action: "wait", marketPick: 95.3, targetPick: 89 });
