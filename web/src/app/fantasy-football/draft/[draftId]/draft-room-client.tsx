...
export default function DraftRoomClient({ initialState }: { initialState: FantasyDraftState }) {
  ...
  return <div className="space-y-5">
    ...
    <p className="text-center text-xs text-muted-foreground">Our independent rankings use nflverse and Sleeper data. Current ADP from Fantasy Football Calculator is comparison-only.</p>
  </div>;
}
