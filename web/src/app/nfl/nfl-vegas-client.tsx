    ...
    <div className="mx-auto max-w-7xl space-y-5 p-4 sm:p-6">
      <header className="rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950 p-5 text-white shadow-lg sm:p-6">
        ...
        <div className="mt-5 flex flex-wrap items-center gap-2">
          ...
          <Link href="/dfs/nfl" className="ml-auto inline-flex min-h-11 items-center gap-2 rounded-lg border border-white/20 bg-white/10 px-4 py-2 text-xs font-bold text-white hover:bg-white/15">NFL DFS workspace</Link>
