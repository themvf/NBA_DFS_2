...
export const nflPbpArchetypes = pgTable("nfl_pbp_archetypes", {
  ...
  turnoverType: text("turnover_type"),
  hadSack: boolean("had_sack"),
  goalLine: boolean("goal_line"),
  penaltyType: text("penalty_type"),
  penaltyTeam: text("penalty_team"),
  penaltyFirstDown: boolean("penalty_first_down"),
  ...
  penaltyYards: doublePrecision("penalty_yards"),
  airYards: doublePrecision("air_yards"),
  yardsAfterCatch: doublePrecision("yards_after_catch"),
  xyacMeanYardage: doublePrecision("xyac_mean_yardage"),
  ...
  xpass: doublePrecision("xpass"),
  passOe: doublePrecision("pass_oe"),
  series: integer("series"),
  seriesSuccess: boolean("series_success"),
  seriesResult: text("series_result"),
  goalToGo: boolean("goal_to_go"),
  outOfBounds: boolean("out_of_bounds"),
  timeoutTeam: text("timeout_team"),
  homeCoach: text("home_coach"),
  awayCoach: text("away_coach"),
  driveTimeOfPossession: text("drive_time_of_possession"),
  driveYardsPenalized: doublePrecision("drive_yards_penalized"),
  driveInsideTwenty: doublePrecision("drive_inside_twenty"),
  wipedEvent: text("wiped_event"),
  wipedYards: doublePrecision("wiped_yards"),
  wipedTouchdown: boolean("wiped_touchdown"),
  wipedTurnover: boolean("wiped_turnover"),
  wipedSack: boolean("wiped_sack"),
  wipedDefender: text("wiped_defender"),
  driveInjuries: integer("drive_injuries"),
  outcome: text("outcome"),
  converted: boolean("converted"),
  scramble: boolean("scramble"),
  twoPointResult: text("two_point_result"),
  driveNoFirstDown: boolean("drive_no_first_down"),
  participationLabellerVersion: text("participation_labeller_version"),
  ...
  gameSecondsRemaining: integer("game_seconds_remaining"),
  halfSecondsRemaining: integer("half_seconds_remaining"),
  roof: text("roof"),
  surface: text("surface"),
  temp: doublePrecision("temp"),
  wind: doublePrecision("wind"),
  spreadLine: doublePrecision("spread_line"),
  totalLine: doublePrecision("total_line"),
  qbDropback: boolean("qb_dropback"),
  firstDown: boolean("first_down"),
  tackledForLoss: boolean("tackled_for_loss"),
  stOutcome: text("st_outcome"),
  kickDistance: doublePrecision("kick_distance"),
  returnYards: doublePrecision("return_yards"),
  passRushers: doublePrecision("pass_rushers"),
  blitz: boolean("blitz"),
  heavyBlitz: boolean("heavy_blitz"),
  nOl: doublePrecision("n_ol"),
  nWr: doublePrecision("n_wr"),
  pressure: boolean("pressure"),
  coverageType: text("coverage_type"),
  manZone: text("man_zone"),
  ...
  driveTurnoverType: text("drive_turnover_type"),
  driveHadSack: boolean("drive_had_sack"),
  driveHadPenalty: boolean("drive_had_penalty"),
  driveFailedShort: boolean("drive_failed_short"),
